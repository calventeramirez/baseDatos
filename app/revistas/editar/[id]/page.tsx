    ...
    const fetchRevista = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          tematica: revistaData.tematica || "",
          editorial: revistaData.editorial || "",
          fechaEdicion: revistaData.fechaEdicion || 0,
          numPag: revistaData.numPag || 0,
          numRevista: revistaData.numRevista || 0,
          fotoPortada: revistaData.fotoPortada || "",
        });
      } catch (error) {
        console.error("Error al cargar la revista:", error);
        setError("Error al cargar los datos de la revista");
      } finally {
  ...
  const validateNumericFields = () => {
    ...
    if (formData.fechaEdicion) {
      ...
      if (
        ...
        fecha < 1500 ||
        fecha > currentYear + 1 ||
        !Number.isInteger(fecha)
      ) {
        errors.push(
          `La fecha de edición debe ser un año válido entre 1500 y ${
            currentYear + 1
          }`
        );
      }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Opcional. Seleccione una imagen para la portada de la revista
              (máximo 5MB)
            </p>
