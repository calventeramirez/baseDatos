                ...
                {obra.foto ? (
                  <div className="text-center">
                    <img
                      ...
                      className="w-64 h-64 object-cover rounded-lg shadow-md border cursor-pointer hover:shadow-lg transition-shadow"
                      onClick={() => handleImageClick(obra.foto!, `${obra.titulo} - ${obra.autor}`)}
                    />
            ...
            {!obra.foto && (
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p>No hay imagen disponible para esta obra</p>
                </div>
              </div>
            )}
          </div>
