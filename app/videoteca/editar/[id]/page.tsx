...
export default function EditarVideoPage() {
  ...
  const formatos = ["DVD", "Blu-ray", "VHS"];
  ...
  if (loading) {
    return (
      <div className="container mx-auto p-6">
        <div className="flex justify-center items-center h-64">
          <div className="text-lg">Cargando video...</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Editar Video</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end pt-4">
            ...
            >
              <Save size={20} />
              {loading ? "Actualizando..." : "Actualizar Video"}
            </button>
          </div>
        </form>
      </div>
